...
class ModeloDeServicioDeFiltro(models.Model):
    ...
    norma_de_referencia = models.ForeignKey(NormaDeReferencia, on_delete=models.PROTECT, null=True, blank=True)
    rCA = models.ForeignKey(RCACliente, on_delete=models.PROTECT, null=True, blank=True)
...
class Servicio(models.Model):
    ...
    observacion = models.TextField(null=True, blank=True,)
    observacion_de_recepcion = models.TextField(null=True, blank=True,)
    fecha_de_recepcion = models.DateTimeField(null=True, blank=True,)
    fecha_de_entrega_cliente = models.DateTimeField(null=True, blank=True,)
    fecha_de_contenedores_o_filtros = models.DateTimeField(null=True, blank=True,)
    norma_de_referencia = models.CharField(max_length=254, null=True, blank=True)
